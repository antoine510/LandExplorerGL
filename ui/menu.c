...
static void initSubMenu(SubMenu* subMenu, xmlNodePtr subMenuNode, Vect2 alignment);
...
Menu* initMenu(KeyStates* keystates)
{
	...
	Vect2 alignment = (Vect2) { asFloatl(menuNode, "Walign")*2.0f - 1.0f, asFloatl(menuNode, "Halign")*2.0f - 1.0f };
...
void initSubMenu(SubMenu* subMenu, xmlNodePtr subMenuNode, Vect2 alignment)
{
...
{
    submenu->labels[0] = label_create(keystates_getKeyName(keystates, key_quit), asPoint(submenu->buttons[0]->rect.x + 110, submenu->buttons[0]->rect.y));
    submenu->labels[1] = label_create(keystates_getKeyName(keystates, key_left), asPoint(submenu->buttons[1]->rect.x + 110, submenu->buttons[1]->rect.y));
    submenu->labels[2] = label_create(keystates_getKeyName(keystates, key_right), asPoint(submenu->buttons[2]->rect.x + 110, submenu->buttons[2]->rect.y));
    submenu->labels[3] = label_create(keystates_getKeyName(keystates, key_up), asPoint(submenu->buttons[3]->rect.x + 110, submenu->buttons[3]->rect.y));
    submenu->labels[4] = label_create(keystates_getKeyName(keystates, key_down), asPoint(submenu->buttons[4]->rect.x + 110, submenu->buttons[4]->rect.y));
    submenu->labels[5] = label_create(keystates_getKeyName(keystates, key_jump), asPoint(submenu->buttons[5]->rect.x + 160, submenu->buttons[5]->rect.y));
    submenu->labels[6] = label_create(keystates_getKeyName(keystates, key_select), asPoint(submenu->buttons[6]->rect.x + 160, submenu->buttons[6]->rect.y));
    submenu->labels[7] = label_create(keystates_getKeyName(keystates, key_map), asPoint(submenu->buttons[7]->rect.x + 160, submenu->buttons[7]->rect.y));
    submenu->labels[8] = label_create(keystates_getKeyName(keystates, key_editor), asPoint(submenu->buttons[8]->rect.x + 160, submenu->buttons[8]->rect.y));
    submenu->labels[9] = label_create(keystates_getKeyName(keystates, key_inventory), asPoint(submenu->buttons[9]->rect.x + 160, submenu->buttons[9]->rect.y));
    submenu->labelCount = 10;
}

void updateKeyLabels(SubMenu* submenu, KeyStates* keystates, KeyType type, int index)
{
    free(submenu->labels[index].text);
