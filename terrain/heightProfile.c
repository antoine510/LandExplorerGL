...
{
    heightProfile->lowScale = calloc(terrain->width, sizeof(float));
    heightProfile->mediumScale = calloc(terrain->width, sizeof(float));
    heightProfile->highScale = calloc(terrain->width, sizeof(float));
    int x;
