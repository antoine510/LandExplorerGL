...
int sap_addClient(SAP* sap, int entityID, Vect2 pos, Vect2 sz)
{
    SAPClient t = {entityID, sap->pointsCount, sap->pointsCount+1, pos.y, pos.y + sz.y};
...
void sap_updateClient(SAP* sap, SAP_CLIENTID clientID, Vect2 pos, Vect2 sz)
{
